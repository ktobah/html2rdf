...
public class SaveRDFXMLABR implements Runnable{
    ...
    public SaveRDFXMLABR(Model model, String base){
        this.model = model;
        this.base = base;
    }
...
class FilterRDFXMLABR extends FileFilter {
    ...
    public String getDescription() {
        return "RDF/XML-Abbreviated file";
    }
}
