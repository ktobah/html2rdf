...
public class SaveRDFNTRIPLES implements Runnable{
    ...
    public SaveRDFNTRIPLES(Model model, String base){
        this.model = model;
        this.base = base;
    }
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                if (decision == choose.APPROVE_OPTION) {
                    ...
                    try {
                        if(fileName.contains(".nt")) file = new FileOutputStream(fileName);
                        else file = new FileOutputStream(fileName+".nt");
...
class FilterRDFNTRIPLES extends FileFilter {
    public final static String rdf = "nt";
