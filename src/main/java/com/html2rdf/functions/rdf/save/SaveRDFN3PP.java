...
public class SaveRDFN3PP implements Runnable{
    ...
    public SaveRDFN3PP(Model model, String base){
        this.model = model;
        this.base = base;
    }
...
class FilterRDFN3PP extends FileFilter {
