...
public class SaveRDFTURTLE implements Runnable{
    ...
    public SaveRDFTURTLE(Model model, String base){
        this.model = model;
        this.base = base;
    }
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                if (decision == choose.APPROVE_OPTION) {
                    ...
                    try {
                        if(fileName.contains(".ttl")) file = new FileOutputStream(fileName);
                        else file = new FileOutputStream(fileName+".ttl");
...
class FilterRDFTURTLE extends FileFilter {
    public final static String rdf = "ttl";
