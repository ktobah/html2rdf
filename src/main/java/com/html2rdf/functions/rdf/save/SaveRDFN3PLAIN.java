...
public class SaveRDFN3PLAIN implements Runnable{
    ...
    public SaveRDFN3PLAIN(Model model, String base){
        this.model = model;
        this.base = base;
    }
...
class FilterRDFN3PLAIN extends FileFilter {
